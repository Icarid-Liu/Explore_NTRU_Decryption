...
void mq_poly_ntt_257_769_mq(int16_t *a, int16_t *nttdata);
...
void mq_poly_mul_ntt_257(int16_t *r, int16_t *a, int16_t *b, int16_t *nttdata);
void mq_poly_mul_ntt_769(int16_t *r, int16_t *a, int16_t *b, int16_t *nttdata);
