...
#define poly_tom KYBER_NAMESPACE(poly_tom)
void poly_tom(poly *r, const poly *a);
#define poly_mul2_modq KYBER_NAMESPACE(poly_mul2_modq)
void poly_mul2_modq(poly *r);
#define poly_sub_Q2 KYBER_NAMESPACE(poly_sub_Q2)
void poly_sub_Q2(poly *r);

#define poly_bit2byte KYBER_NAMESPACE(poly_bit2byte)
